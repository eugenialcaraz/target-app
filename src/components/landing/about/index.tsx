...
const About = () => (
  <div className={styles.container}>
    ...
    <p className={styles.about}>
      ...
      to sleep on floor. Cat snacks. Eat owner&aposs food nap all day, for chase
      imaginary bugs, yet throwup on your pillow. Bleghbleghvomit my furball
      really tie the room together sun bathe attack the dog then pretend like
      nothing happened Gate keepers of hell and destroy couch, so find empty
      spot in cupboard and sleep all day groom yourself 4 hours - checked, have
